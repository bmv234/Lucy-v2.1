...
def main():
    ...
    print("   a. Accept the security warning for https://{local_ip}:6000")
    print("   b. Accept the security warning for wss://{local_ip}:9765")
    ...
    print("   - Main web application (port 6000)")
    print("   - WebSocket server for real-time communication (port 9765)")
    print("5. Text-to-Speech is provided by external MeloTTS server on port 6050")
    print("================================\n")
    ...
    try:
        ...
        if not wait_for_server('https://localhost:6000', 'Main application'):
